...
extension UIViewController {
    ...
    func showErrorAlert(_ title: String = "Sorry", message: String? = nil, actionTitle: String = "OK", completionHandler: (() -> Void)? = nil) {
        UIManager.showErrorAlert(title, message: message, actionTitle: actionTitle, parentController: self, completionHandler: completionHandler)
    }
